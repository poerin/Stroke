...
namespace Stroke.Configure
{
    public partial class CompileConfigure : Form
    {
        ...
        {
            this.Text = Localization.GetString("FormCompileConfigure_Title");
            labelAssemblies.Text = Localization.GetString("LabelAssemblies");
            labelNamespaces.Text = Localization.GetString("LabelNamespaces");
        }
