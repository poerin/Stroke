...
namespace Stroke.Configure
{
    public partial class GestureConfigure : Form
    {
        ...
        public GestureConfigure()
        {
            ...
            ToolStripMenuItemAddGesture.Text = Localization.GetString("ContextMenu_AddGesture");
            ToolStripMenuItemRemoveGesture.Text = Localization.GetString("ContextMenu_RemoveGesture");
        ...
        {
            this.Text = Localization.GetString("FormGestureConfigure_Title");
        }

        private void GestureConfigure_Load(object sender, EventArgs e)
        {
            ApplyLocalization();
        }
